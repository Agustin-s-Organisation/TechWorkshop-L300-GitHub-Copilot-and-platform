...
Now that GitHub Enterprise security featuers are configured, you will make changes to the code and observe how to secret scanning features can help you prevent commiting secrets to your repository. 
